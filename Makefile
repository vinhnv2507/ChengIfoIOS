...
VCamOverlay_FRAMEWORKS = UIKit Foundation AVFoundation CoreMedia CoreImage ImageIO QuartzCore WebKit
...
VCam_CFLAGS = -fobjc-arc -Wno-deprecated-declarations
VCam_FRAMEWORKS = UIKit Foundation Photos PhotosUI AVFoundation CoreMedia CoreImage ImageIO
